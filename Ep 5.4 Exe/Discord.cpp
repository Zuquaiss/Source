...
void Data() {
    ...
    if (Level != 0) {
        ...
        Kill = (int)*reinterpret_cast<long*>(0x21FDEFC);
        MapID = (int)*reinterpret_cast<short*>(0x8666C4);
        Job = (int)*reinterpret_cast<short*>(0x867D92);

        std::string s = std::to_string(Kill);
        char const* KillCount = s.c_str();

        strcpy_s(dwCharName, CharName);
        strcat_s(dwCharName, " | ");
        strcat_s(dwCharName, KillCount);
        strcat_s(dwCharName, " kills");
    }
    else
    {

        strcpy_s(dwCharName, "Logging the game");
        MapID = -1;
        Job = -1;
    }
}
...
const char* getMapName(int mapId) {
    ...
    case 82: return "Nature Forest";
    case 83: return "Mordor";
    case 84: return "Colosseum";
    case 85: return "Ice FFA";
    case 86: return "Rohan";
    case 87: return "Fire FFA";
    case 88: return "Wonderland";
    }
    return "";
}
...
void Initialize()
{
    ...
    Discord_Initialize("", &Handle, 1, NULL); // Your RPC Client ID
}
...
void Update()
{
    ...
    discordPresence.details = dwCharName; // Char Name
